...
\setkomafont{section}{\setmainfont{Cinzel}\LARGE}
\setkomafont{subsection}{\setmainfont{Cinzel}\Large}
\setkomafont{subsubsection}{\setmainfont{Cinzel}\large}
...
%\end{tikzpicture}
\vfill
\includegraphics[scale=0.05]{dragon_bust.png}
